      ...
      <div className="bg-gray-50 h-[78%] overflow-auto">
        ...
        <div className="px-5 py-2 flex justify-between items-center">
          ...
          <div className="flex-1 flex justify-end">
            <Select
              label="Select list style type"
              className="max-w-xs"
              color="secondary"
              onChange={(e) => {
                const indexStyle = e.target.value;
                const style = listStyleType.find((font, index) => {
                  return +indexStyle === +index;
                });
                dispatch(updateListStyleType(style));
              }}
            >
              {listStyleType.map((style, index) => (
